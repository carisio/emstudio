...
{
private:
	bool firstToggledVisibleLayer;
	std::vector<std::pair<wxString, int> > toggledVisibleLayersNames;
public:
    mpWindow() {}
    ...
    */
    ...
    bool AddToggleVisibleLayer( mpLayer* layer, bool refreshDisplay = true);
...
protected:
    ...
    void OnShowHideLayers(wxCommandEvent& event); // Adicionado por Leandro
    ...
    void OnSavePlot      (wxCommandEvent   &event); //!< ADICIONADO POR LEANDRO
