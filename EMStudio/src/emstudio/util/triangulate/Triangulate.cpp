...
float Triangulate::Area(const CoordinatesVector &contour)
{
...
bool Triangulate::Snip(const CoordinatesVector &contour,int u,int v,int w,int n,int *V)
{
  int p;
...
bool Triangulate::Process(const CoordinatesVector &contour,CoordinatesVector &result)
{
