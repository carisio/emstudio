...
public:
	...
	*/
	...
	\endverbatim
	*/
	void xq_card(int itmp1, InformSimulationStatusSmartPointer statusSP = InformSimulationStatusSmartPointer(), int initialPercentage = 0, int totalPercentage = 0);
...
\param A - Requests calculation of average power gain over the region covered by field points. 
	...
	*/
	void rp_card(int calc_mode,
		...
		InformSimulationStatusSmartPointer statusSP = InformSimulationStatusSmartPointer(), int initialPercentage = 0, int totalPercentage = 0);
	...
	*/
	void simulate(bool far_field_flag = false, InformSimulationStatusSmartPointer statusSP = InformSimulationStatusSmartPointer(), int initialPercentage = 0, int totalPercentage = 0);
